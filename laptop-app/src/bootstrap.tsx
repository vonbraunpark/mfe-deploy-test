...
export const vueLaptopAppMount = (el: string | Element, eventBus: any) => {
...
export const vueLaptopAppUnMount = () => {
    if (app) {
        app.unmount();
        app = null;
    }
...
const root = document.querySelector('#laptop-app')

if (root) { vueLaptopAppMount(root, eventBus) }
